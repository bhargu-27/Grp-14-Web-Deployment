...
const stripeSession = async(plan) => {
    try {
        const session = await stripe.checkout.sessions.create({
            ...
            success_url: `${process.env.REACT_APP_FRONTEND_URL}/success`, // URL to redirect on successful payment
            cancel_url: `${process.env.REACT_APP_FRONTEND_URL}/cancel` // URL to redirect on cancelled payment
        });
        return session;
    }catch (e){
        return e;
